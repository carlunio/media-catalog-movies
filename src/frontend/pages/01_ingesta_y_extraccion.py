...
c5.metric("Sin titulo ES IMDb", stats.get("needs_title_es", 0))
c6.metric("Sin OMDb", stats.get("needs_omdb", 0))
c7.metric("Sin traduccion", stats.get("needs_translation", 0))
c8.metric("Pendiente revision", stats.get("needs_workflow_review", 0))
